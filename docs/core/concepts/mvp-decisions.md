...
- `EVENT` - абстрактный концепт в ядре (5-й базовый концепт)
...
**Решение**: EVENT - это абстрактный концепт, как TASK, WORKFLOW, AGENT, CONTEXT.
...
- Не имеют реализации
- Примеры: TASK, WORKFLOW, AGENT, CONTEXT, EVENT
